...
NOTE: These vCenter Server permissions apply to ONTAP tools vCenter users, not to VSC administrators. By default, VSC administrators have full access to the product and do not require permissions assigned to them.
