...
[.lead]
The 9.x releases of ONTAP tools for VMware vSph ere support in-place upgrade to the latest version.
...
To upgrade to ONTAP tools 9.10 you should be running virtual appliance 9.7.1 or later.  Upgrading from an earlier version prior to 9.7.1 of the virtual appliance is not supported.
