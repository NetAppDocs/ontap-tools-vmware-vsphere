...
To create a new user and to connect a cluster or an to ONTAP tools, you should perform the following:
...
NOTE: You must refer to the knowledge base articles if you want to manually configure roles and privileges using ONTAP commands.
