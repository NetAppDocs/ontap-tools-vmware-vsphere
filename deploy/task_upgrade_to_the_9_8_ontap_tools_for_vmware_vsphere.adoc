...
[.lead]
You can perform an in-place upgrade to the latest release of ONTAP tools from your existing 9.7.1 or later release following the instructions provided here.
