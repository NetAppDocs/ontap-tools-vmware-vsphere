...
xref:task_registering_oncommand_api_services_with_the_virtual_appliance_for_vsc_vasa_provider_and_sra.adoc[Registering OnCommand API Services with ONTAP tools]
