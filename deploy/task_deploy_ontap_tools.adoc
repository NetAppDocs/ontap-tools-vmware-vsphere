...
NOTE: If you are using ONTAP 9.6 or earlier, then to view the vVols dashboard, you must download and install . But for ONTAP 9.7 you do not require to be registered with VASA Provider.
