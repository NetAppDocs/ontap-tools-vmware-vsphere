...
link:../deploy/reference_configure_the_vsc_preferences_files.html[Configure the VSC preferences files]
...
+
xref:task_upgrade_to_the_9_8_ONTAP_tools_for_Vmware_vSphere.html[Upgrade to the 9.8 ONTAP tools]
...
xref:concept_requirements_for_deploying_the_virtual_appliance_for_vsc_vasa_provider_and_sra.html[Requirements for deploying the ONTAP tools]
