...
a|
The SSL certificate is automatically generated when you deploy the ONTAP tools. You might have to regenerate the SSL certificate to create a site-specific certificate.link:task_regenerate_an_ssl_certificate_for_vsc.md#[Regenerate an SSL certificate for Virtual Storage Console]
...
* link:task_configure_esx_server_multipathing_and_timeout_settings.md#[Configure ESXi server multipathing and timeout settings]
* link:reference_esxi_host_values_set_by_vsc_for_vmware_vsphere.md#[ESXi host values set using ONTAP® tools for VMware vSphere]
