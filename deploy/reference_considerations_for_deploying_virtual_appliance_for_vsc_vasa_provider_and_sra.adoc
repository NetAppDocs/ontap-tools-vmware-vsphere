...
a|
The deployment of the ONTAP tools automatically installs the VSC features.link:concept_deploy_or_upgrade_ontap_tools.html[Deploying or upgrading ONTAP® tools for VMware vSphere]
...
* link:concept_standard_roles_packaged_with_virtual_appliance_for_vsc_vp_and_sra.hhtml[Standard roles packaged with ONTAP tools]
