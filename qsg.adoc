...
+
If you are using vCenter7.0u3e and later releases perform the following actions, otherwise proceed to Step 5:

* Download the _OTV_INTER_ROOT_CERT_CHAIN.pem_ file from the build folder.
