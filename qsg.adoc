...
+
NOTE: (Optional) If you want to create containers without registering to vCenter Server, then in the Configure vCenter or Enable VCF section, select the Enable VMware Cloud Foundation (VCF) checkbox.
