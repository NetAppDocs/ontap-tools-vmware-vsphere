...
* When Platform type is *Performance* and Asymmetric flag is *TRUE*, type is AFF-A  
* When Platform type is *Performance* and Asymmetric flag is *False*, the type is ASA-A
* When Platform type is *Capacity* and Asymmetric flag is *True*, the type is AFF-C
* When Platform type is *Flash hybrid array* and Asymmetric flag is NA, the type is FAS
