...
. Configure SRM with the ONTAP tools IP address and password using the command: `perl command.pl -I administrator '<otv-password>'`. You need to have a single quote around the password value. 
